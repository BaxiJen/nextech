        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <h1 className="text-4xl font-bold tracking-tight mb-4 text-foreground" style={{ fontFamily: 'var(--font-newsreader, serif)' }}>A BaXiJen®</h1>
            ...
            {/* Hero visual */}
            <motion.div
              className="relative h-[400px] w-full mb-16 rounded-2xl overflow-hidden border border-primary/10"
            ...
            >
              ...
              <div className="absolute bottom-1/3 right-1/3 w-56 h-56 rounded-full bg-[#97c459]/8 blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="w-32 h-32 rounded-full border border-primary/10" />
                <div className="absolute inset-0 m-auto w-20 h-20 rounded-full border border-primary/8" />
              </div>
            ...
            {/* Missão / Visão / Valores — BuritiCards */}
        ...
        <Container>
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: 'var(--font-newsreader, serif)' }}>Equipe</h2>
