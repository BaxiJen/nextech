...
const services = [
  { title: 'BXat Corporativo', description: 'IA Vertical para empresas e instituições. Agentes customizados treinados para o seu domínio — atendimento, análise e automação. Soberania de dados garantida, infraestrutura brasileira.', href: '/bxat', icon: Bot },
  { title: 'GREC', description: 'Gerenciamento de Risco e Crises. Plataforma de monitoramento e gestão de crises com IA, já em operação. Solução madura (TRL 9) para proteção institucional.', href: '/grec', icon: ShieldCheck },
